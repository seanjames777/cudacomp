...
tests = [
    ...
    (SOURCE_DIR + "tests/testPointers4.cc", 0),
    (SOURCE_DIR + "tests/testPointers5.cc", 0),
    (SOURCE_DIR + "tests/testPointers6.cc", "error"),
    (SOURCE_DIR + "tests/testPointers7.cc", 10),
    (SOURCE_DIR + "tests/testPointers8.cc", 20),
    (SOURCE_DIR + "tests/testPointers9.cc", 0),
    (SOURCE_DIR + "tests/testStructs1.cc", 0),
    (SOURCE_DIR + "tests/testStructs2.cc", 5),
    (SOURCE_DIR + "tests/testStructs3.cc", 1),
    (SOURCE_DIR + "tests/testStructs4.cc", 5),
    (SOURCE_DIR + "tests/testStructs5.cc", 5),
    (SOURCE_DIR + "tests/testStructs6.cc", 10),
    (SOURCE_DIR + "tests/testStructs7.cc", 13),
    (SOURCE_DIR + "tests/testStructs8.cc", 10),
    (SOURCE_DIR + "tests/testStructs9.cc", 1),
    (SOURCE_DIR + "tests/testStructs10.cc", 1),
    (SOURCE_DIR + "tests/testStructs11.cc", 1),
    (SOURCE_DIR + "tests/testStructs12.cc", 1),
    (SOURCE_DIR + "tests/testStructs13.cc", 1),
